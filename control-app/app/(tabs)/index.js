...
const SETTINGS_KEY = "whatsapp-media-bot-control-settings-v1";
const CONTROL_TOKEN_KEY = "whatsapp-media-bot-control-token-v1";
...
const COMMAND_TARGETS = ["ping", "ai", "ia", "tono", "idioma", "proveedor", "anime", "phub", "xvideos", "nsfw", "ayuda", "help"];
const PROVIDER_DEFAULTS = {
  ...
  llama_cpp: { model: "local-model", url: "http://127.0.0.1:8080/v1/chat/completions" },
  localai: { model: "local-model", url: "http://127.0.0.1:8081/v1/chat/completions" },
